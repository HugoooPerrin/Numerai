...
models = {'ExtraTrees1':[1, 10, 15, ExtraTreesClassifier(n_jobs = nCores, 
                                                        criterion = 'entropy',
                                                        max_depth = 3,
                                                        bootstrap = True),
         ...
         'ExtraTrees2': [1, 10, 15, ExtraTreesClassifier(n_jobs = nCores, 
                                                        criterion = 'gini',
                                                        max_depth = 3,
                                                        bootstrap = True),
         ...
         # 'XGBoost':     [1, 2, 40, XGBClassifier(max_depth = 3, 
         #                                         n_estimators = 30,
         #                                         nthread = nCores),
         ...
         'SGDC':        [1, 10, 15, SGDClassifier(loss = 'log',
                                                 penalty = 'elasticnet',
